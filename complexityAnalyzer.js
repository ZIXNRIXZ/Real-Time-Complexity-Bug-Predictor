 ...
 */
function analyzeComplexity(ast, languageId) {
    const results = [];
 ...
 */
function findFunctionNodes(ast, languageId) {
    const functionNodes = [];
 ...
 */
function calculateComplexity(node, languageId) {
    // Count nested loops
 ...
 */
function countNestedLoops(node, languageId) {
 ...
 */
function checkForRecursion(node, languageId) {
    // Get function name
 ...
 */
function checkForKnownAlgorithms(node, languageId) {
 ...
 */
function containsSort(node, languageId) {
    let hasSort = false;
    traverseAST(node, (currentNode) => {
 ...
 */
function containsBinarySearch(node, languageId) {
