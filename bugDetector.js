 ...
 */
function detectBugs(ast, languageId, complexityResults) {
    const results = [];
 ...
 * @returns Array of bug results
 */
function detectInfiniteLoops(ast, languageId) {
    const results = [];
 ...
 */
function getLoopNodeTypes(languageId) {
    switch (languageId) {
        case 'python':
 ...
 */
function mightBeInfiniteLoop(node, languageId) {
 ...
 * @returns Array of bug results
 */
function detectRecursionWithoutBaseCase(ast, languageId) {
    const results = [];
 ...
 * @returns Array of node types
 */
function getFunctionNodeTypes(languageId) {
    switch (languageId) {
        case 'python':
 ...
 */
function getFunctionName(node, languageId) {
 ...
 */
function isRecursiveFunction(node, functionName, languageId) {
 ...
 */
function isCallToFunction(node, functionName, languageId) {
 ...
 * @returns Array of node types
 */
function getCallNodeTypes(languageId) {
    switch (languageId) {
        case 'python':
            return ['call'];
        case 'cpp':
 ...
 * @returns The function name or undefined
 */
function getCalledFunctionName(node, languageId) {
 ...
 */
function hasBaseCase(node, languageId) {
 ...
 * @returns Array of bug results
 */
function detectExcessiveComplexity(complexityResults) {
    const results = [];
...
//# sourceMappingURL=bugDetector.js.map